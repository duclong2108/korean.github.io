const QUIZ_BANK = {
    "이/가": [
        ...
        },
        {
            ...
            options: ["가", "이", "는", "를"],
            ans: 0,
            explain: "저 + 가 = 제가 (Tôi là Kim Min Su). Tuy nhiên, câu giới thiệu bản thân thông thường hay dùng 저는 hơn. Dù vậy, về mặt cấu trúc ngữ pháp có thể điền 가 tạo thành 제가."
        },
        {
            q: "_____ 이름입니까?",
        ...
        },
        {
            ...
            ans: 2,
            explain: "형 có patchim (ㅇ) -> 형이. 동생 có patchim (ㅇ) -> 동생이. Câu mang tính chất mô tả sự trạng thái đơn thuần sự vật/sự việc."
        },
        {
    ...
    "에서": [
        ...
        },
        {
            ...
            options: ["도서관에서 책을 읽어요.", "공원에서 산책해요.", "학교에서 가요.", "한국에서 한국어를 배워요."],
            ans: 2,
            explain: "학교에서 가요 (từ trường đi) nếu hiểu theo nghĩa điểm xuất phát thì được, nhưng để nói 'ĐI ĐẾN trường' phải dùng 학교에 가요. Hành động 가다/오다 khi biểu thị đích đến dùng 에 chứ không dùng 에서."
        },
        {
    ...
    "-아/어서 (nguyên nhân)": [
        ...
        {
            q: "Câu 'Vì khó nên tôi không học đâu' dịch chuẩn tiếng Hàn nhất là:",
            options: ["어려워서 안 배울 거예요.", "어려우서 안 배울 거예요.", "어렵어서 안 배울 거예요.", "어렵아서 안 배울 거예요."],
            ans: 0,
            explain: "어렵다 (Khó) + 어서 = 어려워서 (Bất quy tắc ㅂ -> 워)."
        },
        {
            q: "Nếu dùng -(으)니까, câu 'Vì khó nên HÃY học đi' sẽ viết là 어려우니까 공부하세요. Bạn CÓ THỂ dùng -아/어서 để viết lại cấu trúc rủ rê như thế này không?",
            options: ["Có", "Không"],
            ans: 1,
            explain: "Đã khẳng định bên trên: Vế đuôi là Mệnh Lệnh Thỉnh Dụ thì KHÔNG dùng chung với -아/어서 được (어려워서 공부하세요 ✗). SỰ KHÁC BIỆT THẦN THÁNH NÀY SẼ CỨU BẠN RẤT NHIỀU ĐIỂM."
        },
        {
            q: "Khi muốn diễn tả 'Vì LÀ...' với Danh Từ có patchim (như Học sinh). Thì chia thế nào?",
            options: ["학생아서", "학생어서", "학생이어서 (hoặc 학생이라서)", "학생서"],
            ans: 2,
            explain: "이다 + 아/어서 = 이어서. Danh từ có patchim: 이어서. Cụm '이라서' cũng rất hay được dùng thay thế trong giao tiếp đời sống."
        }
    ],
    "-고 싶다": [
        {
